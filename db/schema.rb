...
ActiveRecord::Schema[8.0].define(version: 2025_05_02_170022) do
  ...
  create_table "attractions", force: :cascade do |t|
    ...
    t.index ["gender_id"], name: "index_attractions_on_gender_id"
    t.index ["profile_id"], name: "index_attractions_on_profile_id"
  end
  ...
  create_table "profiles_rooms", force: :cascade do |t|
    ...
    t.index ["room_id"], name: "index_profiles_rooms_on_room_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "first_signin_ip_address"
  ...
  add_foreign_key "profiles_rooms", "profiles"
